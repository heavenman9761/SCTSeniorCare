...
public class AppConstants {
    ...
    public static final String KEY_MEMBER_ID_DEFAULT = "";

    public static final String KEY_HUB_ID = "hub_id";
    public static final String KEY_HUB_ID_DEFAULT = "";
    ...
    public static final String DEVICE_TYPE_DEFAULT = DEVICE_TYPE_BLE; //DEVICE_TYPE_BOTH;
    ...
    public static final String KEY_SERV_USER_ID = "USER_ID";
    public static final String KEY_SERV_PASSWD = "USER_PASSWD";
    public static final String KEY_SERV_AUTO_LOGIN = "AUTO_LOGIN";
}
